  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created chapter" do
        post :create, {:chapter => valid_attributes}, valid_session
        response.should redirect_to(Chapter.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved chapter as @chapter" do
        ...
        post :create, {:chapter => { "name" => "invalid value" }}, valid_session
        assigns(:chapter).should be_a_new(Chapter)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested chapter" do
        ...
        Chapter.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => chapter.to_param, :chapter => { "name" => "MyString" }}, valid_session
      end
      ...
      it "redirects to the chapter" do
        chapter = Chapter.create! valid_attributes
        put :update, {:id => chapter.to_param, :chapter => valid_attributes}, valid_session
        response.should redirect_to(chapter)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the chapter as @chapter" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Chapter.any_instance.stub(:save).and_return(false)
        put :update, {:id => chapter.to_param, :chapter => { "name" => "invalid value" }}, valid_session
        assigns(:chapter).should eq(chapter)
      end
